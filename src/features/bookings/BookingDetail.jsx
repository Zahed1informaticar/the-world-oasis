  ...
  return (
    <>
      ...
      <ButtonGroup>
        ...
        {status === "checked-in" && <Button icon={<HiArrowUpOnSquare />} onClick={() => checkedout(bookingId)} disabled={isCheckingOut}>
          Check out
        </Button>}
        ...
        <Modal>
          ...
          <Modal.Open opens="delete">
            <Button variation="danger" icon={<HiTrash />} disabled={isCheckingOut}>
              Delete
            </Button>
          </Modal.Open>
