...
function Stats({ confirmedStays, bookings, numDays, cabinCount }) {
    ...
    return (
        <>
            ...
            <Stat title="Check-ins" icon={<HiOutlineCalendarDays />} color="indigo" value={checkins} />
            <Stat title="occupancy rate" icon={<HiOutlineChartBar />} color="yellow" value={Math.round(occupation * 100) + "%"} />
        </>
    )
}
