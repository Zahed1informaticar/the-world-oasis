  ...
  return (
    <StyledSalesChart>
      ...
      <ResponsiveContainer height={300} width="100%">
        {/* To make this we want to install this library "npm i recharts@2" before using any of this commands! */}
        <AreaChart data={data}>
          ...
          <Area name="Total Sales" unit="$" strokeWidth={2} dataKey="totalSales" type="monotone" stroke={colors.totalSales.stroke} fill={colors.totalSales.fill}></Area>
          <Area name="Extras Sales" unit="$" strokeWidth={2} dataKey="extrasSales" type="monotone" stroke={colors.extrasSales.stroke} fill={colors.extrasSales.fill}></Area>
        </AreaChart>
      </ResponsiveContainer>
    </StyledSalesChart>
  )
